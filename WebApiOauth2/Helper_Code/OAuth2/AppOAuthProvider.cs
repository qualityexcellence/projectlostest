...
namespace TestingProject1.Helper_Code.OAuth2
{
    ...
    public class AppOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        /// </summary>
        private UserRepository databaseManager = new UserRepository();
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            try
            {
                user = this.databaseManager.Login(usernameVal, passwordVal);
            }
            catch (Exception e)
            {
